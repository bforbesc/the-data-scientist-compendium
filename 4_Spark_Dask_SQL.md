...
- [XGboost](https://xgboost.readthedocs.io/en/stable/tutorials/dask.html): 
  - Examples of a full implementation: [#1](https://github.com/coiled/coiled-resources/blob/main/blogs/dask-python-xgboost-example-100GB-synth-dataset.ipynb); [#2](https://matthewrocklin.com/blog/work/2017/03/28/dask-xgboost); [#3](https://medium.com/rapids-ai/a-new-official-dask-api-for-xgboost-e8b10f3d1eb7)
  - Possible bugs:
